...
//     $query = "DELETE FROM `contact` WHERE `id` IN($all)";
...
// else {
//     $_SESSION['error'] = 'Select checkbox to delete Contact.';
// }
}
            ...
            <div class="col-md-12 margin-30">
                <div class="content-home">
                    ...
                    <div class="table-responsive margin-30">
                        <form name="bulk_action_form" action="contact-us.php" method="POST"
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            while ($row = $sqlDataFecth->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo isset($row['Date']) ? date('Y-m-d', strtotime($row['Date'])) : ''; ?> </td> 
