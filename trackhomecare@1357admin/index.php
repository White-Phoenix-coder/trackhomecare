...
<div class="container">
  <div class="row">
    <div class="col-md-12 margin-60">
      ...
      <!-- <div class="text-center"><a href="index.php"><img src="images/f-logo.png" alt="" class="img-responsive center-block" style="width: 200px;"> </a> </div> -->
      <a href="index.php"><img src="images\logo.webp" alt="" class="img-responsive center-block"> </a>
        <div class="col-md-12 margin-40">
        	<?php if(isset($msg)){echo $msg;}?>
          <form name="myForm" id="myForm" method="post" onSubmit="return validate()">
            <div class="form-group">
            <!-- <a href="index.php"><img src="images/logo.jpg" alt="" class="img-responsive center-block"> </a> -->
