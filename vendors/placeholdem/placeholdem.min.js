 ...
 */
 ...
 function Placeholdem(e) {
	...
	return t.customElems = ["password"], t.defaultInputAttributeName = "data-defaultinputtype", t.init = function() {
		...
		return "function" == typeof e.hasAttribute && e.hasAttribute("")
		...
		n.init = function() {
			...
			if (-1 != t.customElems.indexOf(n.defaultInputType)) {
				n.elem.setAttribute(t.defaultInputAttributeName, n.defaultInputType);
				if (n.defaultInputType === 'email') {
					n.elem.setAttribute('type', 'email');
				} else {
