...
include 'trackhomecare@1357admin/connection.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $recaptchaSecret = '6LcnzK0qAAAAAHQ4ggjx31rVgc_LF2kItKLC0Bit'; // Replace with your secret key from Google reCAPTCHA
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            // Sanitize and process data
                ...
                $to = "office@ajinfotek.in,irfanansari889933@gmail.com";
                $subject = "Track Home";
